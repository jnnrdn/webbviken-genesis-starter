...
<div style="background-color:#111111;padding-top:4.5%" class="wp-block-genesis-blocks-gb-container gb-block-container alignfull"><div class="gb-container-inside"><div class="gb-container-content" style="max-width:1600px"><!-- wp:genesis-blocks/gb-cta {"buttonText":"Get Started Today","buttonBackgroundColor":"#2E8787","ctaBackgroundColor":"#111111","ctaTextColor":"#f5f5f5"} -->
<div style="background-color:#111111;text-align:center" class="wp-block-genesis-blocks-gb-cta gb-block-cta"><div class="gb-cta-content"><h2 class="gb-cta-title gb-font-size-32" style="color:#f5f5f5">Ready to take your next step?</h2><div class="gb-cta-text gb-font-size-32" style="color:#f5f5f5"><p>Grow your audience and build a profitable online business.</p></div></div><div class="gb-cta-button"><a href="#" target="_self" rel="noopener noreferrer" class="gb-button gb-button-shape-rounded gb-button-size-medium" style="color:#ffffff;background-color:#2E8787">Get Started Today</a></div></div>
